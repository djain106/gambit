...
const WHEEL_NUMBERS = [0, 32, 15, 19, 4, 21, 2, 25, 17, 34, 6, 27, 13, 36, 11, 30, 8, 23, 10, 5, 24, 16, 33, 1, 20, 14, 31, 9, 22, 18, 29, 28, 12, 35, 3, 26];
        ...
        <div className="circle">
            {WHEEL_NUMBERS.map((num, index) =>
                <div key={index} className="slice" style={{
                    ...
                    <p style={{ transform: `skewY(${-(share - 90)}) rotate(${share / 2}deg)` }}>
                        {num}
                    </p>
                </div>
            )}
